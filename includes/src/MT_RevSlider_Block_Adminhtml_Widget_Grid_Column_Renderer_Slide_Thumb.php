...
class MT_RevSlider_Block_Adminhtml_Widget_Grid_Column_Renderer_Slide_Thumb
        ...
        if (isset($params['slide_thumb']) && $params['slide_thumb']){
            ...
            switch ($params['background_type']){
                ...
                case 'solid':
                    ...
                    break;
                case 'trans':
                    return '<div style="width:100px;height:80px;background:url('.$this->getSkinUrl('mt/revslider/images/trans_tile2.png').');"></div>';
                    break;
                case 'external':
