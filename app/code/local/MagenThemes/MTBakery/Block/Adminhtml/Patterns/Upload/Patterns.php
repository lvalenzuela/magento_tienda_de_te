...
?>
<?php
class MagenThemes_MTBakery_Block_Adminhtml_Patterns_Upload_Patterns extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element){ 
       	$html = parent::_getElementHtml($element);
		$directry = Mage::getBaseDir('media').DS.'wysiwyg'.DS.'magenthemes'.DS.'mtbakery'.DS.'patterns';
		...
		$html .='<div class="listpattern '.$element->getHtmlId().'_pattern">';
			...
			$html .='<span class="item">
						<img src="'.$urlparth.'media/wysiwyg/magenthemes/mtbakery/patterns/'.$img.'" />
