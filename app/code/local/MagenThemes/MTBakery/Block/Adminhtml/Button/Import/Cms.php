...
?>
<?php
class MagenThemes_MTBakery_Block_Adminhtml_Button_Import_Cms extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
		...
		$url = $this->getUrl('mtbakery/adminhtml_import/' . $name);
