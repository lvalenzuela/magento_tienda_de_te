...
?>
<?php
class MagenThemes_MTBakery_Adminhtml_RestoreController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')
            ->isAllowed('magenthemes/mtbakery/restore');
    }

    protected function _initAction()
    {
        $this->loadLayout()
            ->_setActiveMenu('magenthemes/mtbakery/restore')
    ...
    public function indexAction()
    {
        ...
        $this->_title($this->__('MagenThemes'))
            ->_title($this->__('MTBakery'))
            ->_title($this->__('Restore Defaults'));
        $this->_addContent($this->getLayout()->createBlock('mtbakery/adminhtml_restore_edit'));
        $this->renderLayout();
    }
    ...
    public function restoreAction()
    {
	    ...
	    try {
            ...
            $defaults->loadFile(Mage::getBaseDir().'/app/code/local/MagenThemes/MTBakery/etc/config.xml');
            $this->_restoreSettings($defaults->getNode('default/mtbakery_design')->children(), 'mtbakery_design');
            Mage::getSingleton('adminhtml/session')->addSuccess(
                Mage::helper('adminhtml')->__('Default Settings for MTBakery Design Theme has been restored.'));
        }
        catch (Exception $e) {
